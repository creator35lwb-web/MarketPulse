...
| **Telegram Channel ID** | ✅ Validated | `***REMOVED***` |
...
| **Send to User Channel** | Telegram | **Credential:** `Telegram API`, **Chat ID:** `***REMOVED***` |
...
| **Send to Admin Channel** | Telegram | **Credential:** `Telegram API`, **Chat ID:** `***REMOVED***` |
